package _03_ELECTRODOMESTICOS_CON_INTERFAZ_Y_ARRAYLIST_;
...
public class PRINCIPAL {
	...
	public static void main(String[] args) {
        ...
        ArrayList<ABSTRACTA_ELECTRODOMESTICOS> ae2 = new ArrayList<ABSTRACTA_ELECTRODOMESTICOS>(10);
        ae2.add(new LAVADORA(300, 120));
        System.out.println(ae2.get(0).toString());
        
        
        ArrayList<LAVADORA> ae = new ArrayList<LAVADORA>();
        ae.add(new LAVADORA(250, 90));
        System.out.println(ae.get(0).toString());
